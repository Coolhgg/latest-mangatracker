...
import { Plus, Search, Grid2X2, List as ListIcon, BookOpen, Star, ArrowUpDown, AlertCircle } from "lucide-react"
...
const LibraryGridItem = memo(function LibraryGridItem({ entry }: { entry: LibraryEntry }) {
  return (
    <Link href={`/series/${entry.series_id}`} className="group relative space-y-3">
      <div className="aspect-[3/4] overflow-hidden rounded-2xl bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 transition-all group-hover:ring-2 group-hover:ring-zinc-900 dark:group-hover:ring-zinc-50 relative shadow-sm group-hover:shadow-md">
